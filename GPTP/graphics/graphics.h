...
namespace graphics {
	...
	const static ColorId standardColors[] = {RED,   BLUE,   TEAL,  PURPLE, ORANGE, BROWN,
	                                         WHITE, YELLOW, GREEN, CYAN,   BLACK,  GREY};
	...
	void drawArrowLine(int x1, int y1, int x2, int y2, ColorId color, CoordType ct = ON_SCREEN);
