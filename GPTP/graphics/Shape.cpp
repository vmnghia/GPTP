...
namespace graphics {
	...
	void Shape::setArrowLine(int x1, int y1, int x2, int y2, ColorId color, CoordType coordType) {
		this->type = ARROW_LINE;
		this->p1.x = x1;
		this->p1.y = y1;
		this->p2.x = x2;
		this->p2.y = y2;
	...
	void Shape::setDottedEllipse2(int left, int top, int right, int bottom, ColorId color1, ColorId color2,
	                              CoordType coordType) {
	...
	void Shape::setChevronLine(int x1, int y1, int x2, int y2, ColorId color, CoordType coordType, int dashLen,
	                           int gapLen) {
		this->type = DOTTED_ARROW_LINE;
		this->p1.x = x1;
		this->p1.y = y1;
		this->p2.x = x2;
		this->p2.y = y2;
	...
	void Shape::draw() const {
		...
		switch (this->type) {
			...
			case TEXT:
				...
				gameScreenBuffer->blitString(getStringFromIndex(this->stringIndex).c_str(), p1.x, p1.y, this->fontSize);
				break;
			...
			case ARROW_LINE:
				gameScreenBuffer->drawArrowLine(p1.x, p1.y, p2.x, p2.y, this->color);
				break;
			...
			case DOTTED_ARROW_LINE:
				gameScreenBuffer->drawChevronLine(p1.x, p1.y, p2.x, p2.y, this->color);
				break;
